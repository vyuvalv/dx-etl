...
//     function submitMessage(e, actionName="init") {
...
(function () {
  ...
  document.querySelector('.lightspeed-prompt-input')?.addEventListener("keydown", 
  function (e) {
      console.log(e.key);
  ...
  window.addEventListener("message", (event) => {
    ...
    //         ? marked.parseInline(
    //             message.value +
    //               "<br /> <br /><pre class='overflow-auto'><code>```" +
    //               message.code +
    //               "```</code></pre>"
    //           )
    //         : message.value;
  ...
  let submitHandler = function (e) {
    e.preventDefault();
    e.stopPropagation();
    const input =  document.querySelector('.lightspeed-prompt-input');
    console.log('clicked ' + input.value);
    // document.getElementById("lightspeed-prompt-input");
