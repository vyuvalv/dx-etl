...
export class HtmlUtils {
  ...
  public static transformHtml(
    ...
    html = HtmlUtils.transformScriptTags(html, pathToApp, webview);
    html = HtmlUtils.transformResourceFolders(html, pathToApp, webview);
  ...
  public static transformScriptTags(
    ...
    while ((matches = HtmlUtils.scriptRegex.exec(html)) !== null) {
      newScriptSrc = webview.asWebviewUri(
        vscode.Uri.file(path.join(pathToApp, matches[1]))
      );
